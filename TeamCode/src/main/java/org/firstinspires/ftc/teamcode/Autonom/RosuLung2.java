...
@Autonomous(name = "AUTONOM ROSU LUNG2")
public class RosuLung2 extends LinearOpMode {
...
//        robot.setBratTarget(0);
        ...
        TrajectorySequence left = drive.trajectorySequenceBuilder(new Pose2d(-36.48, -60.70, Math.toRadians(90.00)))

                .lineTo(new Vector2d(-36.04, -36.48))
                .waitSeconds(0.2)
                ...
                .lineTo(new Vector2d(-35.60, -11.08))
                .lineTo(new Vector2d(33.54, -10.50))
...
//                .lineTo(new Vector2d(42.20, -14.02))
                .lineTo(new Vector2d(49.25, -35.45))
