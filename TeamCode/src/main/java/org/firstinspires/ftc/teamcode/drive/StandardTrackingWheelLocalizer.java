...
public class StandardTrackingWheelLocalizer extends ThreeTrackingWheelLocalizer {
    ...
    public static double LATERAL_DISTANCE = 13.7795; // in; distance between the left and right wheels xx
    public static double FORWARD_OFFSET = 4.92126; // in; offset of the lateral wheel xx
